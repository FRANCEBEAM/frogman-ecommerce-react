  ...
  return (
    ...
    <div className='flex items-center justify-between w-full lg:max-w-[1200px] lg:m-auto lg:flex lg:items-center lg:justify-between'>
        ...
        <div>
            ...
            <ul className={clickBars ? 'w-full h-[300px] absolute bg-[#000000] justify-center text-white font-medium uppercase left-0 top-[84px] text-center pt-10 transition-all duration-300': 'absolute top-[-600%] w-full left-0 text-center transition-all duration-300 uppercase lg:top-0 lg:flex right-0 lg:text-white lg:text-lg  gap-9 lg:relative lg:right-0'}>
                ...
                <li className='font-medium tracking-wider py-3 hover:text-red hover:bg-yellow cursor-pointer lg:hover:text-black lg:text-base lg:text-black lg:font-bold lg:bg-yellow lg:hover:bg-yellow/90 lg:px-3 lg:rounded-lg'>
                    <Link>
                        Play Now
                    </Link>
                </li>
